...
def test_too_few_columns_are_passed(columns_2, settings_number_of_columns_3):  # pylint: disable=unused-argument
...
def test_correct_number_columns_are_passed(columns_4, settings_number_of_columns_4):  # pylint: disable=unused-argument
