...
@pytest.fixture()
def in_data_even_criteria_views():
...
def test_even_example(in_data_even_criteria_views, out_even_rows):
    """Even example generates expected rows"""
    instance = views.EvenVMC()
    rows = instance.process_entries(in_data_even_criteria_views)
    assert rows == out_even_rows


def test_criteria_example(in_data_even_criteria_views, criteria_functions_3, function_args_3, out_criteria_rows):
    """Criteria example generates expected rows"""
    instance = views.CriteriaVMC()
    rows = instance.process_entries(in_data_even_criteria_views, criteria_functions_3, function_args_3)
    assert rows == out_criteria_rows
