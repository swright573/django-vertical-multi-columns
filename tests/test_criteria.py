...
def test_no_column_setting_and_fewer_than_3_functions_are_passed(settings_NUMBER_OF_COLUMNS_Null,
...
def test_no_column_setting_and_more_than_3_functions_are_passed(settings_NUMBER_OF_COLUMNS_Null,
...
def test_no_column_setting_and_3_functions_are_passed(settings_NUMBER_OF_COLUMNS_Null,
                                                      entries_27,
...
def test_number_of_functions_same_as_columns_setting(settings_NUMBER_OF_COLUMNS_4,
                                                     entries_27,                                                     
                                                     criteria_functions_4,
                                                     function_args):
    # The number of "criteria functions" and "func args" passed by the user must correspond to the columns setting
...
def test_number_columns_kwarg_no_setting(settings_NUMBER_OF_COLUMNS_Null,
                                         entries_27, 
